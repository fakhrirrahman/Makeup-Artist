...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="{{route('awal.contact')}}" class="nav-link">Contact</a></li>
        </ul>
      </div>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center">
        <div class="col-md-9 ftco-animate text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="{{route('awal.index')}}">Home</a></span> <span>Contact
              us</span></p>
        </div>
      </div>
    </div>
  ...
  <section class="ftco-section contact-section">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-4 contact-info ftco-animate bg-light p-4 text-center">
          <div class="row">
            <div class="col-md-12 mb-4">
              <h2 class="h4">Kontak Informasi</h2>
            </div>
            <div class="col-md-12 mb-3">
              <p style="color: black"><span>Alamat:</span> Potrokasan RT 2/ RW 5, Kowangan, Temanggung, 56218</p>
            </div>
            <div class="col-md-12 mb-3">
              <p><span>No Whatsapp:</span> <a href="https://wa.me/6288215571069">+62 882-1557-1069</a></p>
            </div>
            <div class="col-md-12 mb-3">
              <p><span>Email:</span> <a href="mailto:nurfaridatrihandayani@gmail.com">nurfaridatrihandayani@gmail.com</a></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <div style="text-align: center;">
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3957.405270154395!2d110.17542600000002!3d-7.3082850000000015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwMTgnMjkuOCJTIDExMMKwMTAnMzEuNSJF!5e0!3m2!1sid!2sid!4v1715164837634!5m2!1sid!2sid"
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <p class="mb-0">
            ...
            </script> Design <i class="icon-heart" aria-hidden="true"></i> by <a href="#" target="_blank">FIRDA MU</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
          </p>
        </div>
      </div>
